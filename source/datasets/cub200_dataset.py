# Dataset Loader implementation from https://github.com/HaoMood/bilinear-cnn/blob/master/src/cub200.py
# inspired by https://github.com/vishwakftw/vision
...
if __name__ == '__main__':
    CUB200(".", download=True)  # Download dataset and process
